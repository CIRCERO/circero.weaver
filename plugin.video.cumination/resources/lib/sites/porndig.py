...
site = AdultSite('porndig', '[COLOR yellow]Porndig[/COLOR] [COLOR crimson]Professional[/COLOR]', 'https://www.porndig.com/',
                 'porndig.gif', 'porndig')
site2 = AdultSite('porndig2', '[COLOR yellow]Porndig[/COLOR] [COLOR crimson]Amateurs[/COLOR]', 'http://www.porndig.com/',
                  'porndig.gif', 'porndig')
...
def Pornstars(url, page=1):
    ...
    for ID, img, studio, videos in match:
        title = "{0} [COLOR crimson][I]{1} videos[/I][/COLOR]".format(studio, videos)
