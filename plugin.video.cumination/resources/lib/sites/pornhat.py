...
site = AdultSite('pornhat', '[COLOR crimson]Pornhat[/COLOR]', 'https://www.pornhat.com/', 'pornhat.png', 'pornhat')
site1 = AdultSite('helloporn', '[COLOR crimson]Hello Porn[/COLOR]', 'https://hello.porn/', 'helloporn.png', 'helloporn')
site2 = AdultSite('okporn', '[COLOR crimson]OK Porn[/COLOR]', 'https://ok.porn/', 'okporn.png', 'okporn')
site3 = AdultSite('okxxx', '[COLOR crimson]OK XXX[/COLOR]', 'https://ok.xxx/', 'okxxx.png', 'okxxx')
site4 = AdultSite('pornstarstube', '[COLOR crimson]Pornstars Tube[/COLOR]', 'https://pornstars.tube/', 'pornstarstube.png', 'pornstarstube')
site5 = AdultSite('maxporn', '[COLOR crimson]Max Porn[/COLOR]', 'https://max.porn/', 'maxporn.png', 'maxporn')
# site6 = AdultSite('homoxxx', '[COLOR crimson]Homo XXX[/COLOR]', 'https://homo.xxx/', 'homoxxx.png', 'homoxxx')
...
def Main(url):
    ...
    if 'max.porn' not in url and 'pornstars.tube' not in url:
        site.add_dir('[COLOR crimson]Channels[/COLOR]', siteurl + 'channels/', 'Cat', site.img_cat)
        if 'hello.porn' in url:
            site.add_dir('[COLOR crimson]Models[/COLOR]', siteurl + 'pornstars/videos/', 'Cat', site.img_cat)
        else:
            site.add_dir('[COLOR crimson]Models[/COLOR]', siteurl + 'models/', 'Cat', site.img_cat)
    if 'pornstars.tube' in url:
        site.add_dir('[COLOR crimson]Search Pornstars[/COLOR]', siteurl + 'search/', 'Search', site.img_search)
    else:
        site.add_dir('[COLOR crimson]Search[/COLOR]', siteurl + 'search/', 'Search', site.img_search)
    if 'hello' in siteurl:
        List(siteurl + 'new/')
...
def List(url):
    ...
    if nextp:
        ...
        site.add_dir('[COLOR crimson]Next Page...[/COLOR] ({0})'.format(np), nextp, 'List', site.img_next)
    utils.eod()
...
def Cat(url):
    ...
    for cat in cats:
        ...
        name += ' [COLOR crimson]' + videos + '[/COLOR]'
    ...
    if nextp:
        ...
        site.add_dir('[COLOR crimson]Next Page...[/COLOR] ({0}{1})'.format(np, lp), nextp, 'Cat', site.img_next)
    utils.eod()
