...
site = AdultSite('xmoviesforyou', '[COLOR yellow]Xmoviesforyou[/COLOR]', 'https://xmoviesforyou.com/', 'xmoviesforyou.gif', 'xmoviesforyou')
...
def List(url):
    ...
    for videopage, name, img in match:
        name = name.replace('[', '[COLOR crimson]').replace('] ', '[/COLOR] ')
