...
site = AdultSite('xhamster', '[COLOR yellow]xHamster[/COLOR]', 'https://xhamster.com/', 'xhamster.gif', 'xhamster')
...
def Main():
    ...
    site.add_dir('[COLOR crimson]Pornstars[/COLOR]', site.url + 'pornstars', 'Pornstars', site.img_cat)
    site.add_dir('[COLOR crimson]Celebrities[/COLOR]', site.url + 'celebrities', 'Celebrities', site.img_cat)
    site.add_dir('[COLOR crimson]Search[/COLOR]', site.url + 'search/', 'Search', site.img_search)
