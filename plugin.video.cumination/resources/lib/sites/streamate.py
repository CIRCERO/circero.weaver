...
def List(url, page=1):
    ...
    for camgirl in model_list['performers']:
        ...
        name = "{0} [COLOR crimson][{1}][/COLOR] {2}".format(camgirl['nickname'], camgirl['age'], status)
        subject = '{0}[CR][COLOR crimson]Location: [/COLOR]{1}'.format(utils.cleantext(camgirl['headlineMessage']), camgirl['country'])
