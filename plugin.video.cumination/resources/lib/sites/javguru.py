...
site = AdultSite('javguru', '[COLOR crimson]Jav Guru[/COLOR]', 'https://jav.guru/', 'https://cdn.javsts.com/wp-content/uploads/2018/12/logofinal6.png', 'javguru')


@site.register(default_mode=True)
def Main():
    site.add_dir('[COLOR crimson]Categories[/COLOR]', site.url + 'wp-json/wp/v2/categories/', 'Catjson', site.img_cat)
    site.add_dir('[COLOR crimson]Actress[/COLOR]', site.url + 'jav-actress-list/', 'Cat', site.img_cat)
    site.add_dir('[COLOR crimson]Studios[/COLOR]', site.url + 'jav-studio-list/', 'Cat', site.img_cat)
    site.add_dir('[COLOR crimson]Uncensored[/COLOR]', site.url + 'category/jav-uncensored/', 'List', site.img_cat)
    site.add_dir('[COLOR crimson]Search[/COLOR]', site.url + '?s=', 'Search', site.img_search)
    List(site.url)
...
def List(url):
    ...
    if match:
        ...
        lp = '/' + lp[0] if lp else ''
        site.add_dir('[COLOR crimson]Next Page...[/COLOR] ({0}{1})'.format(np, lp), npage, 'List', site.img_next)
    utils.eod()
