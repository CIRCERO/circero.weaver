...
site = AdultSite('spankbang', '[COLOR crimson]SpankBang[/COLOR]', 'https://spankbang.com/', 'spankbang.gif', 'spankbang')
...
def Main():
    site.add_dir('[COLOR crimson]Categories[/COLOR]', site.url + 'categories', 'Categories', site.img_cat)
    site.add_dir('[COLOR crimson]Models[/COLOR]', site.url + 'pornstars_alphabet', 'Models_alphabet', site.img_cat)
    site.add_dir('[COLOR crimson]Search[/COLOR]', site.url + 's/', 'Search', site.img_search)
    site.add_dir('[COLOR crimson]Quality: [/COLOR] [COLOR orange]{}[/COLOR]'.format(filterQ), '', 'FilterQ', '', Folder=False)
    site.add_dir('[COLOR crimson]Length: [/COLOR] [COLOR orange]{}[/COLOR]'.format(filterL), '', 'FilterL', '', Folder=False)
...
def Models(url):
    ...
    for catpage, name, videos in match:
        name = name + '[COLOR crimson]{}[/COLOR]'.format(videos)
